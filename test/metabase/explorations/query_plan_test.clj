(ns metabase.explorations.query-plan-test
  "Tests for the orchestrator's planner-selection logic and end-to-end
  materialization. Planner-specific validators and variant emission live in
...
(deftest pick-planner-test
  (testing "pick-planner! returns the deterministic mechanical planner"
...
(deftest planner-protocol-implementations-test
  (testing "The mechanical planner satisfies the QueryPlanner protocol and names itself"
